# Form implementation generated from reading ui file 'video_editor/ui/qt/mainwindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(23, 10, 761, 511))
        ...
        self.btn_select = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        ...
        self.btn_export = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        ...
        self.label_video = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        self.label_video.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.label_brightness = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.slider_brightness = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        ...
        self.label_saturation = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.slider_saturation = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        ...
        self.label_blur = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.slider_blur = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        ...
        self.label_sepia = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.slider_sepia = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        ...
        self.label_sharpen = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.slider_sharpen = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        ...
        self.label_canny = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        ...
        self.slider_canny = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        ...
        self.btn_play_pause = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        ...
        self.slider_video = QtWidgets.QSlider(parent=self.verticalLayoutWidget)
        self.slider_video.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.slider_video.setObjectName("slider_video")
        self.horizontalLayout_5.addWidget(self.slider_video)
